  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="flex flex-1">
        ...
        {(isMobile || isTablet) && (
          <header className={`md:hidden fixed left-0 right-0 z-30 glass border-b border-border/50 shadow-sm ${
            isDemoMode ? 'top-10 sm:top-12' : 'top-0'
          }`}>
            <div className="flex h-14 items-center justify-between px-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="min-w-0 min-w-[90px] md:min-w-[110px] max-w-full">
